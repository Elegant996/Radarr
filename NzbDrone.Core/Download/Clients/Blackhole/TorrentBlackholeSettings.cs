...
namespace NzbDrone.Core.Download.Clients.Blackhole
{
    ...
    public class TorrentBlackholeSettings : IProviderConfig
    {
        ...
        [DefaultValue(false)]
        [JsonProperty(DefaultValueHandling = DefaultValueHandling.Populate)]
        [FieldDefinition(3, Label = "Read Only", Type = FieldType.Checkbox, HelpText = "Instead of moving files this will instruct Radarr to Copy, Symlink or Hardlink (depending on settings/system configuration)")]
