...
namespace NzbDrone.Core.MediaFiles
{
    ...
    public class EpisodeFileMovingService : IMoveEpisodeFiles
    {
        ...
        public EpisodeFile CopyEpisodeFile(EpisodeFile episodeFile, LocalEpisode localEpisode)
        {
            ...
            {
                _logger.Debug("Symlinking episode file: {0} to {1}", episodeFile.Path, filePath);
                return TransferFile(episodeFile, localEpisode.Series, localEpisode.Episodes, filePath, TransferMode.SymbolicLinkOrCopy);
            }
