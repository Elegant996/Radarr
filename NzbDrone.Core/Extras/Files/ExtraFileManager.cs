...
namespace NzbDrone.Core.Extras.Files
{
...

    {
        ...
        protected TExtraFile ImportFile(Series series, EpisodeFile episodeFile, string path, string extension, bool readOnly)
        {
            ...
            if (readOnly)
            {
                transferMode = _configService.CopyUsingSymlinks ?
                    TransferMode.SymbolicLinkOrCopy : (_configService.CopyUsingHardlinks ? TransferMode.HardLinkOrCopy : TransferMode.Copy);
            }
